...
public class ToastManager {
    ...
    private static String toastMsgs[][] = {
            ...
            {
                    "4개의 모드를 선택하세요", "4개 초과 선택할 수 없습니다", "하나 이상의 패턴을 사용해야합니다", "1~40 사이의 값을 입력해주세요", "잠시 후 다시 시도해주세요",
            ...
            {
                    "Please select 4 modes", "Can not select more than 4 modes", "Must use more than 1 pattern", "Please enter a value between 1 and 40", "Please try again",
            ...
            {
                    "请选择4个模式", "请勿超过选择4个模式", "请使用一个以上模式", "请输入1~40之间的温度", "请稍等重试",
